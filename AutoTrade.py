...
objRq.SetInputValue(3, 51)  # 거래량 상위순
objRq.SetInputValue(4, ord('1'))  # 관리 종목 제외
objRq.SetInputValue(5, ord('0'))  # 거래량 전체
objRq.SetInputValue(6, ord('1'))  # '표시 항목 선택 - '1':5일 '2':20일 '3':60일

objRq.BlockRequest()

cnt = objRq.GetHeaderValue(0)  # 해당 종목 건수
...
if __name__ == '__main__': 
    try:
        ...
        buy_percent = 0.25   # 매수할 종목 수가 4종목이면 0.25, 2종목이면 0.50
